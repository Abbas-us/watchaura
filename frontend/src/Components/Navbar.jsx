    ...
    return(
        <div className="navbarPage">    
            <div id="nav-container">
                <nav>
                    <h1><i class="fa-regular fa-clock"></i>ABBAS</h1>
                    <ul>
                    ...
                    <button><li><NavLink to={'/admin/dashboard'}>CART ITEMS</NavLink></li></button>
                    <button><NavLink to={'/auth-signup'} className="home-nav2-link">LOGOUT</NavLink></button>
